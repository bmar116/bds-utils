...
```
wget -O /tmp/bds-utils.zip https://github.com/bmar116/bds-utils/releases/latest/download/bds-utils.zip && unzip -d /tmp/bds-utils /tmp/bds-utils.zip && cd /tmp/bds-utils && bash install.sh
```
